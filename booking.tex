...
\put(20,-53.5){\parbox[t][10mm]{180mm}{\centering \footnotesize Please submit completed form to theatre co-ordinator}}%comment above consultant cluster
...
{\bf Category 5 -- less than 48 hours -- time critical surgery.} Patient's condition is stable.\\}
 ...
 \put(201,-288){\rotatebox{90}{AHC Emergency Theatre Booking Form }} %vertical text band
\end{picture}
\end{document}
